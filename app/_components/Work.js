  ...
  return (
    <div className="bg-white py-10">
        ...
        <div className="px-5 md:px-8 lg:px-14">
          <div className="grid grid-cols-4 bg-secondary rounded-3xl p-6">
            ...
            <div className="col-span-1">
              <Image src="/images/insured1.jpg" alt="Person Image" width={600} height={400} className=" rounded-3xl overflow-hidden h-[300px] object-cover object-top"/>
            </div>
          </div>
        </div>
    </div>
